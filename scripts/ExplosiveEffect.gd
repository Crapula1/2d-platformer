...
func _spawn_visuals() -> void:
	...
	flash.offset_left  = -26; flash.offset_top    = -26
	flash.offset_right =  26; flash.offset_bottom =  26
	add_child(flash)

	var ring := ColorRect.new()
	ring.color = Color(1.0, 0.52, 0.05)
	ring.offset_left  = -18; ring.offset_top    = -18
	ring.offset_right =  18; ring.offset_bottom =  18
	add_child(ring)

	var smoke := ColorRect.new()
	smoke.color = Color(0.18, 0.15, 0.12, 0.7)
	smoke.offset_left  = -11; smoke.offset_top    = -11
	smoke.offset_right =  11; smoke.offset_bottom =  11
	add_child(smoke)
